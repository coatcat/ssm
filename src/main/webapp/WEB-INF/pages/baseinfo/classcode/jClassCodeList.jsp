...
分类名称：	            	
<input type="text" name="name" value="${obj.name}" size="30"
	onFocus="this.select();"
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.name}</td>
		<td>
			<input type="button" name="btnView" value="查看" onclick="formSubmit('toview.action?id=${o.id}','_self');" class="input"/>
			<input type="button" name="btnDel" value="删除" onclick="formSubmit('delete.action?id=${o.id}','_self');"/>
		</td>
	</tr>
	</c:forEach>
